...
#terminal-listing(title: [Audit first, then build the isolated fixtures as an ordinary user], "cd /path/to/learn-ebpf-on-linux\njust kernel-audit\njust smoke\n\ncd samples/05-verifier-lab/rejected\ncargo build --release --target bpfel-unknown-none\n\ncd ../corrected\ncargo build --release --target bpfel-unknown-none") <lst-audit-build>
